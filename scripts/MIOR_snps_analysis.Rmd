---
title: 'Microtus oregoni Autosomal vs Sex chromosomee genetic structure '
...
installing packages if running script for the first time in your computer

```{r install packages}
# installing from GitHub requires devtools
