...
# Loking into the difference/ deffentiation between autosomes and sex chromosomes 
# We have samples with both aoutosomes and sex chromosomes: 
# The males have Xp-Xm SNPs  
# The fenames have Xo-Xm SNPs 
# We expect to see Xm-Xp differences and no autosome differences. 
# The M. oregoni assembly has both Xm-Xp-Xo. The aim of our analysis is to test whether any parts of this # assembly differ between the individuals from the aoutosomes and sex chromosomes. 

In the first part of the analysis, we are going to create a heat map of the x-linked and autosomal SNPs of the individuals and we are going to run Principal Component Analysis (PCA) on these SNPs 
This will allow us to test if any of the individuals cluster together by their automsome/Xp-Xm/Xm-Xo.
...
Totorial: (https://wurmlab.com/genomicscourse/2019/practicals/population_genetics/popgen)
Analysis of genome data: (https://grunwaldlab.github.io/Population_Genetics_in_R/analysis_of_genome.html)
